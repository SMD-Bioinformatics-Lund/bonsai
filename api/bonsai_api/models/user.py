...
from .base import UUIDMixin, ForbidExtraModelMixin, RWModel, TimestampsMixin
...
class UserInputDatabase(UserBase, TimestampsMixin):  # pylint: disable=too-few-public-methods
