...
from .samples.permissions import READ_PERMISSION as SAMPLES_READ_PERMISSION
from .samples.permissions import WRITE_PERMISSION as SAMPLES_WRITE_PERMISSION
