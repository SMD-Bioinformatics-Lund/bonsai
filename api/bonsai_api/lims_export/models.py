...
class FieldDefinition(BaseModel):
    ...
    no_result_value: str = Field(
        default="NA", description="Analysis present, no result"
    )
    missing_analysis_value: str = Field(
        default="MA", description="Analysis missing, but expected"
    )
