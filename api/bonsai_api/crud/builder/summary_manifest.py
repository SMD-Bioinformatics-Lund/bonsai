...
MANIFEST = Manifest(
    columns=[
        ...
        ColumnFull(id="sample_name", label="Name", path="$sample_name", default_visible=True),
        ColumnFull(id="lims_id", label="LIMS id", path="$lims_id", default_visible=True),
        ...
        ColumnFull(id="postalignqc_median_cov", requires=['postalignqc'], label="median coverage", path="$postalignqc.median_cov", type="number"),
