...
- Resolve reference genomes by internal ID, assembly accession, or sequence accession, and seed additional organism groups. [#PR](https://github.com/SMD-Bioinformatics-Lund/bonsai/pull/PR)
