...
- Put `Mutation pavisad` in the third LIMS export column and curated mutation details in the fourth column. [#PR](https://github.com/SMD-Bioinformatics-Lund/bonsai/pull/PR)
