...
- Retry IGV without variant zoom when its initial locus cannot be found, show a reference-mismatch warning, and display load failures instead of leaving the viewer stuck loading. [#PR](https://github.com/SMD-Bioinformatics-Lund/bonsai/pull/PR)
