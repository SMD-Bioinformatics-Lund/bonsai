...
- Authenticate IGV configuration requests with the user's API token instead of their username, fixing unauthorized responses when opening IGV. [#PR](https://github.com/SMD-Bioinformatics-Lund/bonsai/pull/PR)
