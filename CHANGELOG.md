...
- Require appropriate sample permissions for clustering, job inspection, analysis uploads and curations, signature/index updates, and sample deletion. [#PR](https://github.com/SMD-Bioinformatics-Lund/bonsai/pull/PR)
